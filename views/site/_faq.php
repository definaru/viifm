        ...
        <div class="accordion-item border-0 rounded">
            ...
            <div id="collapse3" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                <div class="accordion-body rounded-bottom border border-top-0">
                    ...
                    за прослушивание музыки, и не продаём её частично или целыми сборниками. Наша платформа создана <u>исключительно
                    в ознакомительных целях</u>. Вы можете скопировать название трека, чтобы найти понравившегося исполнителя на просторах интернета.
                </div>
            </div>
        </div>
        <div class="accordion-item border-0 rounded">
